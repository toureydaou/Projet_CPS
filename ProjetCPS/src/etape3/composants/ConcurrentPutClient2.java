...
public class ConcurrentPutClient2 extends ClientBCM {
	...
	private void ecritureConcurrente() throws Exception {
		...
		System.out.println("============= Insertion concurrente des clés 55, 65, 75, 85, 95, 105, 115 (PUT 1)  ==============");
		...
		System.out.println("Insertion clé 55 (put1)");

		System.out.println("");

		ContentDataI value_55 = this.put(new EntierKey(55), new Livre("Nouveau Harry Potter55 put 1", 700));
		System.out.println("Résultat attendu (PUT-1-55) : null");
		System.out.println("Résultat obtenu (PUT-1-55) : " + value_55);

		System.out.println("");

		System.out.println("Insertion clé 65 (put1)");

		System.out.println("");

		ContentDataI value_65 = this.put(new EntierKey(65), new Livre("Nouveau Harry Potter65 put 1", 700));
		System.out.println("Résultat attendu (PUT-1-65) : null");
		System.out.println("Résultat obtenu (PUT-1-65) : " + value_65);

		System.out.println("");

		System.out.println("Insertion clé 75 (put1)");

		System.out.println("");

		ContentDataI value_75 = this.put(new EntierKey(75), new Livre("Nouveau Harry Potter75 put 1", 700));
		System.out.println("Résultat attendu (PUT-1-75) : null");
		System.out.println("Résultat obtenu (PUT-1-75) : " + value_75);

		System.out.println("");

		System.out.println("Insertion clé 85 (put1)");

		System.out.println("");

		ContentDataI value_85 = this.put(new EntierKey(85), new Livre("Nouveau Harry Potter85 put 1", 700));
		System.out.println("Résultat attendu (PUT-1-85) : null");
		System.out.println("Résultat obtenu (PUT-1-85) : " + value_85);

		System.out.println("");

		System.out.println("Insertion clé 95 (put1)");

		System.out.println("");

		ContentDataI value_95 = this.put(new EntierKey(95), new Livre("Nouveau Harry Potter95 put 1", 700));
		System.out.println("Résultat attendu (PUT-1-95) : null");
		System.out.println("Résultat obtenu (PUT-1-95) : " + value_95);

		System.out.println("");

		System.out.println("Insertion clé 105 (put1)");

		System.out.println("");


		ContentDataI value_105 = this.put(new EntierKey(105), new Livre("Nouveau Harry Potter105 put 1", 700));
		System.out.println("Résultat attendu (PUT-1-105) : null");
		System.out.println("Résultat obtenu (PUT-1-105) : " + value_105);

		System.out.println("");

		System.out.println("Insertion clé 115 (put1)");

		System.out.println("");


		ContentDataI value_115 = this.put(new EntierKey(115), new Livre("Nouveau Harry Potter115 put 1", 700));
		System.out.println("Résultat attendu (PUT-1-115) : null");
		System.out.println("Résultat obtenu (PUT-1-115) : " + value_115);
