 ...
 *
 * <p>
 * Ce port est utilisé par un composant client pour envoyer des résultats au
 * serveur dans le cadre d'un système de computation, comme un système
 * MapReduce.
 * </p>
 *
 * <p>
 * <strong>Propriétaire du port :</strong> Le propriétaire de ce port est un
 * composant client qui envoie des résultats de calculs à un serveur ou à un
 * autre composant.
 * </p>
 *
