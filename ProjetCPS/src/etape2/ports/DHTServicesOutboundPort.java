...
public class DHTServicesOutboundPort extends AbstractOutboundPort implements DHTServicesCI {
	...
	/**
	 * Permet d'appeler le service <code>get</code> du connecteur
	 * <code>DHTServicesConnector</code> pour déclencher la récupération d'une
	 * donnée dans la table de hachage avec une clée donnée.
	 * 
	...
	/**
	 * Permet d'appeler le service <code>put</code> du connecteur
	 * <code>DHTServicesConnector</code> pour déclencher l'insertion d'une donnée
	 * dans la table de hachage avec une clée et une valeur donnée.
	 * 
	 * @param compoutationURI URI de la requete.
	...
	/**
	 * Permet d'appeler le service <code>remove</code> du connecteur
	 * <code>DHTServicesConnector</code> pour déclencher la suppression d'une donnée
	 * dans la table de hachage avec une clée donnée.
	 * 
	 * @param compoutationURI URI de la requete.
	...
	/**
	 * Permet d'appeler le service <code>mapReduce</code> du connecteur
	 * <code>DHTServicesConnector</code> pour déclencher le map reduce des données
